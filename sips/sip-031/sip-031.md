...
At the end of Bitcoin block height 905,449, the following vote was recorded: **A total of 310,806,111 STX participated, with 303,143,381 STX (97.53%) voting 'Yes' and 7,663,233 STX (2.47%) voting 'No'.**

A breakdown of the vote is as follows:
- For STX locked in stacking, a total of 242,886,942 STX participated.
     - Of this, 239,963,583 STX (98.90%) from xx accounts voted 'Yes'.
     - while 2,923,359 STX (1.20%) voted 'No'.
- For unlocked STX, a total of 67,919,672 STX participated.
     - Of this, 63,179,798 STX (93.02%) from x,xxx accounts voted 'Yes'.
     - while 4,739,874 STX (6.98%) voted 'No'.

A copy of the scripts used to tabulate the solo and pool stacking can be found [here](https://github.com/stacksgov/sips/blob/main/sips/sip-031/sip031-votes-script.zip).
